...
const Cart = () => {
  ...
  // Se ainda não houver cartId ou não logado, mostra mensagem
        ...
        <div className="text-center bg-gray-800 rounded-lg p-8 shadow-xl max-w-md w-full">
          ...
          <h1 className="text-2xl font-bold mb-4">
            {isAuthenticated
              ...
              : 'Você precisa estar logado para usar o carrinho.'}
          </h1>
          ...
          >
            {isAuthenticated ? 'Ir para a página inicial' : 'Ir para o login'}
          </button>
        </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-16 px-6 bg-gray-800 rounded-lg">
            ...
            <button
              onClick={() => navigate('/')}
              className="mt-4 bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-lg"
            >
              Adicionar Produtos
            </button>
          </div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={async () => {
                    try {
                      await LimparCarrinho(Number(cartId));
                      clearCart();
